...
// console.log(getAllItemsList())
// console.log(isValidBarcodes(['0001', '0003', '0005', '0003']))
// console.log(getBarcodesInformation(['0001', '0003', '0005', '0003']))
// console.log(settleItemsFromBarcodes([ { name: 'Coca Cola', price: 3, total: 1 },
//     { name: 'Pepsi-Cola', price: 5, total: 2 },
//     { name: 'Dr Pepper', price: 7, total: 1 } ]))
// console.log(renderTotal(20))
...
// console.log(renderReceipt({ sum: 20,
//     itemList:
//         [ { name: 'Coca Cola', price: 3, total: 1 },
//             { name: 'Pepsi-Cola', price: 5, total: 2 },
//             { name: 'Dr Pepper', price: 7, total: 1 } ] }))
// console.log(printReceipt(['0001', '0003', '0005', '0003']))
